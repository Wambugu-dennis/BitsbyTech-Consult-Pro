...
import { 
  ...
  DownloadCloud, 
  Brain,
  Cpu, // For Generate Visualization button
  TableIcon, // For table option
  PieChart as LucidePieIcon, // For pie chart option
  BarChartIcon as LucideBarChartIcon, // For bar chart option
  LineChart as LucideLineChartIcon, // For line chart option
  AlertTriangle
} from "lucide-react";
